...
export function SignIn() {
  ...
  const [hasPendingAuth, setHasPendingAuth] = useState(() => {
    ...
    return sessionStorage.getItem(AUTH_PENDING_KEY) === "true";
  });
  ...
  const authError = authErrorParam
    ...
    : hasTimedOut
      ...
      : signInError;
  const isAwaitingCallback = !authError && (hasPendingAuth || isAuthCallback);
  ...
  useEffect(() => {
    ...
    // If auth callback never resolves, recover instead of spinning forever.
